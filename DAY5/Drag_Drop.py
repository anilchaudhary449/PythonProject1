...
action.drag_and_drop(Drag_Me_btn1,notGreedyOuter_droppable1).perform()

time.sleep(3)
notGreedy_innerDroppable=driver.find_element(By.ID,"notGreedyInnerDropBox")
action.drag_and_drop(Drag_Me_btn1,notGreedy_innerDroppable).perform()
...
action.drag_and_drop(Drag_Me_btn2,greedyOuter_droppable2).perform()

time.sleep(3)
Greedy_innerDroppable=driver.find_element(By.XPATH,"//div[@id='greedyDropBoxInner']")
action.drag_and_drop(Drag_Me_btn2,Greedy_innerDroppable).perform()
